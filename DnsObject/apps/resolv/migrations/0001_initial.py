    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolv_ip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipinfo.IPinfo', to_field='ipaddress', verbose_name='IP')),
            ],
            options={
                'db_table': 'resolv',
                'managed': True,
        ...
        migrations.AlterUniqueTogether(
            name='resolv',
            unique_together=set([('resolv_ip', 'agentid')]),
        ),
    ]
