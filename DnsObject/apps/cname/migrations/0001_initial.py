    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.CharField(editable=False, max_length=30, verbose_name='\u521b\u5efa\u8005')),
                ('update_user', models.CharField(editable=False, max_length=30, verbose_name='\u4fee\u6539\u8005')),
        ...
        migrations.AlterUniqueTogether(
            name='cname',
            unique_together=set([('agentid', 'cname', 'domain')]),
        ),
    ]
