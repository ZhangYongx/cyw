# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-02 05:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agtStates', models.IntegerField(choices=[('r', 'running'), ('d', 'down'), ('p', 'pause'), ('u', 'unknown')], verbose_name='\u8fd0\u884c\u72b6\u6001')),
                ('remarks', models.CharField(blank=True, max_length=45, null=True, verbose_name='\u5907\u6ce8')),
                ('createTime', models.DateTimeField(auto_now_add=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('upTime', models.DateTimeField(auto_now=True, verbose_name='\u66f4\u65b0\u65f6\u95f4')),
                ('createUser', models.CharField(default='now user', editable=False, max_length=30, verbose_name='\u521b\u5efa\u7528\u6237')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createUser', models.CharField(default='now user', editable=False, max_length=30, verbose_name='\u521b\u5efa\u7528\u6237')),
                ('updateUser', models.CharField(default='now user', max_length=30, verbose_name='\u66f4\u65b0\u7528\u6237')),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dnsmasq.Area', verbose_name='\u533a\u57df')),
            ],
            options={
                'db_table': 'cname',
            },
        ...
        migrations.AddField(
            model_name='alias',
            name='area',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dnsmasq.Area', verbose_name='\u533a\u57df'),
        ),
        migrations.AddField(
            model_name='agent',
            name='area',
